...
// P_CheckMeleeRange
//
static boolean P_CheckMeleeRange(void *thing)
{
	mobj_t *actor = thing;
	mobj_t *pl;
	fixed_t dist;
...
// P_CheckMissileRange
//
static boolean P_CheckMissileRange(void *thing)
{
	mobj_t *actor = thing;
	fixed_t dist;
...
static void P_NewChaseDir(void *thing)
{
	mobj_t *actor = thing;
...
// var2 = unused
//
void A_Invinciblerize(void *thing)
{
	mobj_t *actor = thing;
	A_Pain(actor);
...
// var2 = unused
//
void A_DeInvinciblerize(void *thing)
{
	mobj_t *actor = thing;
